          ...
          <div className="card w-100">
            <div className="card-body p-3">
              <div className="mt-3 d-flex justify-content-between align-items-baseline ">
                <h5 className="card-title fw-semibold mb-4">Inspectors</h5>
    ...
    <div className="container-fluid pt-4 pb-0">
      <div class="row">
        <div class="col-12">
          ...
          <div class="modal fade" style="z-index: 99999" id="modal-leave" tabindex="-1" role="dialog"
                      ...
                      <form role="form text-left">
                        ...
                        <div class="input-group mb-3">
                          <input type="text" class="form-control" placeholder="Email" aria-label="Email"
                            aria-describedby="email-addon" onfocus="focused(this)" onfocusout="defocused(this)" />
                        </div>
                        <label>Value</label>
                        <div class="input-group mb-3">
                          <input type="text" class="form-control" placeholder="Password" aria-label="Password"
                            aria-describedby="password-addon" onfocus="focused(this)" onfocusout="defocused(this)" />
                        </div>
                        ...
                        <div class="row text-center">
                          ...
                          <div class="col-6">
                            <button type="submit" class="btn btn-outline-primary btn-md w-100 mt-2 mb-0">
                              Add
                            </button>
                          </div>
                        </div>
            ...
            <div class="card-header pb-0 p-3">
              <div class="row">
                <div class="col-6 d-flex align-items-center">
                  <h6 class="mb-0">Inspector List</h6>
                </div>
              </div>
            </div>
            <div class="card-body p-3">
              <div class="d-sm-flex justify-content-between p-0">
                ...
                <div class="d-flex">
                  ...
                  <router-link to="/addIns" class="btn btn-icon btn-outline-dark ms-2 export">
                    <span class="btn-inner--icon"><i class="ni ni-archive-2"></i></span>
                    <span class="btn-inner--text">Add Inspector</span>
                  </router-link>

                  <button class="btn btn-icon btn-outline-dark ms-2 export" @click="exportToCSV" type="button">
                    <span class="btn-inner--icon"><i class="ni ni-archive-2"></i></span>
              ...
              <div class="table-responsive" id="tbl_exporttable_to_xls_4">
                  ...
                  <tbody>
                    <tr v-for="inspector in Inspectors" :key="inspector.id">
                      ...
                      <td class="font-weight-bold">
                        <span class="my-2 text-xs">{{ inspector.name }}</span>
                      </td>
                      <td class="font-weight-bold">
                        <span class="my-2 text-xs">{{ inspector.email }}</span>
                      </td>
                      <td class="font-weight-bold">
                      ...
                      <td class="text-xs font-weight-bold p-0 pt-1">
                        <button class="btn btn-outline-dark btn-xs p-1 mb-1 me-1" @click="deleteInspector(inspector.id)">
                          Remove
                        </button>
                        <router-link :to="{ name: 'viewI', params: { Id: inspector.id } }">
                ...
                <!-- modal of delivery starts -->
                <div class="modal fade" style="z-index: 99999" id="modal-delivery" tabindex="-1" role="dialog"
                  aria-labelledby="modal-form" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                      <div class="modal-body p-0">
...
export default {
  ...
  methods: {
    getInspectors() {
      InspectorService.getInspector().then((response) => {
    ...
    exportToCSV() {
      const Inspectors = this.Inspectors;
      const ws = XLSX.utils.json_to_sheet(this.Inspectors);
      const wb = XLSX.utils.book_new();
      XLSX.utils.book_append_sheet(wb, ws, "Inspectors");
      XLSX.writeFile(wb, "Inspectors.csv");
    },
  },

  created() {
    this.getInspectors();
    setInterval(this.getInspectors, 1000);
  },
};
</script>
