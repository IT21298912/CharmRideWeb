                    ...
                    <div className="card w-100">
                        <div className="card-body p-3">
                            <div className="mt-3 d-flex justify-content-between align-items-baseline ">
                                <h5 className="card-title fw-semibold mb-4">Bookings</h5>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                      ...
                      <span class="btn-inner--text">Booking Listr</span>
                    </router-link> -->

                                    <button class="btn btn-icon btn-outline-dark ms-2 export" @click="exportToCSV"
                                        type="button">
                                        <span class="btn-inner--icon"><i class="ni ni-archive-2"></i></span>
                                    ...
                                    <tbody>
                                        <tr v-for="booking in Bookings" :key="booking.bid">
                                            ...
                                            <td class="font-weight-bold">
                                                <span class="my-2 text-xs">{{ booking.uid }}</span>
                                            </td>
                                            <td class="font-weight-bold">
                                                <span class="my-2 text-xs">{{ booking.vid }}</span>
                                            </td>
                                            <td class="font-weight-bold">
                                                <span class="my-2 text-xs">{{ booking.date }}</span>
                                            </td>
...
export default {
    ...
    created() {
        this.getBookings();
        setInterval(this.getBookings, 1000);
    },
};
</script>
